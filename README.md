...
As I went I rewrote Seiya's guide to use Rust, which you can find here **([https://github.com/tews-code/operating-system-in-1000-lines/en](https://github.com/tews-code/operating-system-in-1000-lines/blob/main/website/en/01-setting-up-development-environment.md))**.
